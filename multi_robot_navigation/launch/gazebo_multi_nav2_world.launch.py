...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb1', 'x_pose': '-1.5', 'y_pose': '-0.5', 'z_pose': 0.0},
        {'name': 'tb2', 'x_pose': '-1.5', 'y_pose': '0.5', 'z_pose': 0.0},
        {'name': 'tb3', 'x_pose': '1.5', 'y_pose': '-0.5', 'z_pose': 0.0},
        {'name': 'tb4', 'x_pose': '1.5', 'y_pose': '0.5', 'z_pose': 0.0},
        # ...
        # ...
        ]
    ...
    multi_robot = get_package_share_directory('multi_robot_simulation')
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            package_dir, 'rviz', 'slam.rviz'),
        description='Full path to the RVIZ config file to use')

    urdf = os.path.join(
        multi_robot, 'urdf', 'my_robot.urdf.xacro'
    )
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'nav_params_file',
        default_value=os.path.join(package_dir, 'params', 'my_robot.yaml'),
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('multi_robot_navigation'), 'maps', 'maze.yaml'),
                     },],
    ...
    for robot in robots:
        ...
        if last_action is None:
            ...
            ld.add_action(my_robot_state_publisher)
